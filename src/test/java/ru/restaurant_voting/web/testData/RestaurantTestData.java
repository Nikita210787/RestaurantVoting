...
public class RestaurantTestData {
    public static MatcherFactory.Matcher<RestaurantIncludeMenu> RESTAURANT_TO_MATCHER = MatcherFactory.usingRecursiveIgnoreFieldsComparator(RestaurantIncludeMenu.class);
    public static MatcherFactory.Matcher<Restaurant> RESTAURANT_MATCHER = MatcherFactory.usingRecursiveIgnoreFieldsComparator(Restaurant.class, "menu.restaurant", "votes");
